...
const requiredTokens = [
  ...
  "--dds-alert-info-bg",
  "--dds-alert-info-text",
  "--dds-alert-info-border",
  "--dds-alert-info-accent",
  "--dds-alert-success-bg",
  "--dds-alert-success-text",
  "--dds-alert-success-border",
  "--dds-alert-success-accent",
  "--dds-alert-warning-bg",
  "--dds-alert-warning-text",
  "--dds-alert-warning-border",
  "--dds-alert-warning-accent",
  "--dds-alert-danger-bg",
  "--dds-alert-danger-text",
  "--dds-alert-danger-border",
  "--dds-alert-danger-accent",
  "--dds-avatar-bg",
  "--dds-avatar-text",
  "--dds-avatar-border",
  ...
  "--dds-progress-radius",
  "--dds-progress-height-sm",
  "--dds-progress-height-md",
  "--dds-breadcrumb-text",
  "--dds-breadcrumb-link",
  "--dds-breadcrumb-current",
  "--dds-breadcrumb-separator",
  "--dds-skeleton-bg",
